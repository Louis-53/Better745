    ...
    if($orders->num_rows>0){
        while ($order = $orders->fetch_assoc()){
            ...
            if($expiryTime != null && $total != null && $expiryTime >= 0 && $notif == 0){
                ...
                if($send != ""){  
                    $msg = " 
        از سرویس اشتراک $remark تنها (۱ $send) باقی مانده است. ⏳ شما می‌توانید از بخش 📦 مدیریت سرویس‌ها، اشتراک فعلی خود را تمدید کرده یا یک سرویس جدید خریداری نمایید. 🛍️
";
